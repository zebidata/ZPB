...
type Info interface {
	...
	GetType() KeyType
	// Name of the privateArmor Key
	GetPrivKeyArmor() string
	// Name of the key
	GetName() string
	// Public key
...
func (i localInfo) GetPrivKeyArmor() string {
...
func (i ledgerInfo) GetPrivKeyArmor() string {
	return ""
}
...
func (i offlineInfo) GetPrivKeyArmor() string {
	return ""
}
...
func (i multiInfo) GetPrivKeyArmor() string {
	return ""
}
